...
const steps = [
  {
    ...
    description: 'Analizamos tus necesidades, diseñamos la arquitectura y definimos el roadmap del proyecto.'
  },
  {
    icon: <Code2 className="w-10 h-10 text-primary" />,
    title: 'Desarrollo Ágil',
    description: 'Construimos tu solución con las mejores prácticas, enviando actualizaciones constantes.'
  },
  {
    icon: <Rocket className="w-10 h-10 text-green-400" />,
    title: 'Lanzamiento & Soporte',
    description: 'Desplegamos en producción y te acompañamos en el crecimiento con mantenimiento continuo.'
  }
];
    ...
    <section id="process" className="py-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          <h2 className="text-sm font-bold tracking-widest text-accent uppercase mb-3">Metodología</h2>
          <p className="text-4xl md:text-5xl font-extrabold text-white mb-6">¿Cómo trabajamos <span className="text-gradient">juntos?</span></p>
          <p className="max-w-2xl mx-auto text-gray-400 text-lg">
            Un proceso transparente y eficiente diseñado para entregar resultados excepcionales en tiempo récord.
          </p>
        </div>
