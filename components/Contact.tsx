        ...
        <div className="glass rounded-[3rem] overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-12 lg:p-16 bg-gradient-to-br from-primary/20 via-accent/10 to-transparent">
              <h2 className="text-4xl font-bold text-white mb-6">Hagamos algo <span className="text-gradient">Extraordinario</span></h2>
              <p className="text-gray-400 text-lg mb-10 leading-relaxed">
                ¿Tienes una idea innovadora o un proceso que necesita automatización? 
                Estamos listos para escucharte y convertir tus desafíos en soluciones digitales de clase mundial.
              </p>
              ...
              <div className="mt-12 pt-12 border-t border-white/10">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-white">hola@arppia.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-12 lg:p-16">
              <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-400 mb-2">Tipo de Proyecto</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-400 mb-2">Cuéntanos más</label>
                  <textarea 
                    rows={4}
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
