      ...
      <section className="relative pt-32 pb-12 lg:pt-48 lg:pb-20 bg-black overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
          ...
          <p className="max-w-2xl mx-auto text-xl text-gray-400">
            Explora cómo ayudamos a las empresas a escalar mediante tecnología
            punta y diseños innovadores.
          </p>
        </div>
      </section>
                ...
                <div className="p-10">
                  ...
                  <div className="flex flex-wrap gap-2 mb-8">
                    {project.tech.map((t) => (
                      <span
                        key={t}
                        className="text-[10px] font-bold uppercase tracking-tighter text-gray-500 bg-white/5 px-3 py-1 rounded-md"
                      >
                        {t}
                      </span>
                    ))}
