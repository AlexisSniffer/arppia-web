...
const TicketsContent = () => {
  ...
  const loadTicket = async (ticketCode: string) => {
    setIsSearching(true)
    const res = await getTicketStatus(ticketCode)
    if (res.success) {
      setTicketData(res)
      setTicketsList([])
      setLookupMethod('id')
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-400 text-lg max-w-2xl mx-auto">
          Consulta el estado de tu mensaje usando tu número de ticket o correo
          electrónico.
        </p>
      </div>
                ...
                >
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-white font-bold">{t.project_type}</p>
