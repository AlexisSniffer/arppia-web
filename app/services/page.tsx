    ...
    <main className="flex flex-col min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="max-w-3xl">
                <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 leading-tight">
                    Soluciones <span className="text-gradient">Tecnológicas</span> para el mañana.
                </h1>
                <p className="text-xl text-gray-400 mb-10 leading-relaxed">
                    En Arppia, no solo desarrollamos software; creamos ventajas competitivas mediante el uso estratégico de la IA, la automatización y el desarrollo web de alto impacto.
                </p>
            </div>
        </div>
      </section>
                            ...
                            <div className="glass p-12 rounded-[3rem] relative overflow-hidden group">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                                    {service.features.map((feature, fIdx) => (
                                        <div key={fIdx} className="flex items-start text-gray-300">
                            ...
                            <div className="relative aspect-video rounded-[3rem] overflow-hidden glass p-4">
                                ...
                                <div className="relative h-full w-full bg-black/40 rounded-[2.5rem] flex items-center justify-center p-8">
                                    <div className="text-center">
                                        <p className="text-sm font-bold uppercase tracking-[0.2em] text-gray-500 mb-4">Stack Tecnológico</p>
                                        <div className="flex flex-wrap justify-center gap-3">
                                            {service.tech.map((t) => (
                                                <span key={t} className="px-4 py-2 bg-white/5 rounded-xl border border-white/10 text-white font-semibold text-sm">
                                                    {t}
                                                </span>
                                            ))}
                                        </div>
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8">¿Algún proyecto en mente?</h2>
            <p className="text-gray-400 text-xl mb-12">Estamos listos para ayudarte a dar el siguiente paso tecnológico.</p>
            <Link 
                href="/#contact"
