...
import { ArrowLeft, CheckCircle2, Lightbulb, TrendingUp, Zap } from 'lucide-react';
    ...
    <main className="flex flex-col min-h-screen">
            ...
            <div>
              ...
              <div className="space-y-6">
                {service.benefits.map((benefit, idx) => (
                  <div key={idx} className="glass p-8 rounded-3xl border-l-4 border-primary transition-all hover:bg-white/5">
            ...
            <div className="space-y-12">
               ...
               <div className="bg-black/50 p-10 rounded-[3rem] border border-white/5">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {service.tech.map((t) => (
                      <span key={t} className="px-4 py-2 bg-white/10 rounded-xl text-white font-semibold text-sm">
                        {t}
                      </span>
                    ))}
                  </div>
      ...
      <section className="py-24 bg-black">
        <div className="max-w-3xl mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold text-white mb-8">Nuestra Metodología para {service.title}</h2>
            <p className="text-gray-400 text-lg leading-relaxed mb-12">
              Desde la consultoría inicial hasta el despliegue final y soporte continuo, seguimos un proceso riguroso para garantizar que cada {service.title} cumpla con los estándares más altos de la industria.
            </p>
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4">
            <div className="bg-gradient-to-br from-primary/30 to-accent/5 p-16 rounded-[4rem] text-center glass border border-white/10">
                <h2 className="text-4xl font-bold text-white mb-8">¿Listo para transformar tu negocio con {service.title}?</h2>
