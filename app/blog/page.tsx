...
const BlogPage = () => {
  ...
  const categories = ['Todos', 'Inteligencia Artificial', 'Automatización', 'Desarrollo'];
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <section className="relative pt-32 pb-12 lg:pt-48 lg:pb-20 bg-black overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
            ...
            <p className="max-w-2xl mx-auto text-xl text-gray-400">
                Ideas, guías y tendencias sobre el futuro de la tecnología y el negocio.
            </p>
        </div>
      </section>
      ...
      <section className="py-12 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <Link href={`/blog/${featuredPost.slug}`} className="group relative block glass rounded-[3rem] overflow-hidden">
                    ...
                    >
                        ...
                        <div className="p-8 flex-grow flex flex-col">
                            ...
                            <div className="mt-auto pt-4 flex items-center text-white font-bold text-sm">
                                Leer más <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                            </div>
                        </div>
                    </Link>
                ))}
