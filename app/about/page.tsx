      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-black">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
          ...
          <p className="max-w-3xl mx-auto text-xl text-gray-400 mb-10">
            Arppia es una agencia de desarrollo digital nacida con un propósito
            claro: democratizar la IA y la automatización avanzada para empresas
            que buscan liderar el mercado.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="glass p-12 rounded-[2.5rem] relative overflow-hidden group">
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                Empoderar a negocios de todos los tamaños mediante soluciones
                tecnológicas inteligentes que optimicen sus operaciones y
                potencien su escalabilidad en un mundo cada vez más digital.
              </p>
            </div>
            ...
            <div className="glass p-12 rounded-[2.5rem] relative overflow-hidden group">
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                Ser el referente global en la convergencia entre desarrollo de
                software de alta calidad y sistemas de inteligencia artificial,
                impulsando la próxima ola de innovación tecnológica.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-4xl font-extrabold text-white">
              Lo que nos <span className="text-gradient">Impulsa</span>
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'No solo escribimos código, construimos arte funcional pensando en cada píxel y cada milisegundo.'
              },
              {
                icon: <Award className="w-6 h-6 text-blue-400" />,
                title: 'Excelencia Técnica',
                desc: 'Nos mantenemos a la vanguardia de las tecnologías de IA y backend para ofrecer siempre lo mejor.'
              },
              {
                icon: <Users className="w-6 h-6 text-green-400" />,
                title: 'Compromiso Total',
                desc: 'Tu éxito es nuestro éxito. Nos convertimos en un socio tecnológico, no solo en un proveedor.'
              }
            ].map((value, idx) => (
              <div
                key={idx}
                className="glass p-8 rounded-3xl text-center hover:translate-y-[-4px] transition-all"
              >
      ...
      <section className="py-24 bg-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-4xl font-extrabold text-white">
              Mentes detrás de <span className="text-gradient">Arppia</span>
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="glass group p-6 rounded-[2rem] text-center overflow-hidden"
              >
        ...
        <div className="max-w-3xl mx-auto px-4 text-center">
          <div className="bg-gradient-to-br from-primary/20 via-accent/10 to-transparent p-12 rounded-[3.52rem] glass">
            ...
            <p className="text-gray-400 mb-10 text-lg leading-relaxed">
              Únete a las empresas que ya están transformando su modelo de
