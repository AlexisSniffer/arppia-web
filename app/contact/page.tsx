    ...
    <main className="flex flex-col min-h-screen bg-black">
      ...
      <section className="relative pt-32 pb-12 lg:pt-40 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
            ...
            <p className="max-w-2xl mx-auto text-xl text-gray-400">
                Estamos listos para transformar tu negocio con tecnología de vanguardia e inteligencia artificial.
            </p>
        </div>
      </section>
      ...
      <section className="relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="relative h-[600px] rounded-[4rem] overflow-hidden glass p-1 border border-white/5">
                <iframe 
                    ...
                    className="w-full h-full rounded-[3.9rem] border-0 grayscale invert opacity-60 contrast-125 brightness-50" 
                    allowFullScreen 
                    loading="lazy"
                ></iframe>
        ...
        <div className="max-w-5xl mx-auto px-4 relative -mt-64 z-20">
            <Contact noPadding showTitle={false} className="bg-transparent shadow-none" />
        </div>
      </section>
      ...
      <section className="py-32 bg-black relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
                <h2 className="text-3xl font-bold text-white mb-4">Otros Canales de Contacto</h2>
                <p className="text-gray-400">Elige la forma más cómoda para ti.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {/* WhatsApp */}
                <a href="https://wa.me/something" className="glass group p-8 rounded-[3rem] flex flex-col items-center text-center hover:bg-white/5 transition-all duration-500">
                ...
                {/* Email */}
                <a href="mailto:hola@arppia.com" className="glass group p-8 rounded-[3rem] flex flex-col items-center text-center hover:bg-white/5 transition-all duration-500">
                ...
                <div className="glass p-8 rounded-[3rem] flex flex-col items-center text-center">
                    ...
                    <div className="flex gap-4">
                        <a href="#" className="p-3 bg-white/5 rounded-xl text-gray-400 hover:text-white transition-all"><Code className="w-5 h-5" /></a>
                        <a href="#" className="p-3 bg-white/5 rounded-xl text-gray-400 hover:text-white transition-all"><X className="w-5 h-5" /></a>
                    </div>
                </div>
            </div>
        </div>
